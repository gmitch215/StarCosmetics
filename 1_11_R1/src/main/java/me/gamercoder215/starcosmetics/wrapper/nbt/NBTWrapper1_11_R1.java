...
public final class NBTWrapper1_11_R1 extends NBTWrapper {

    public NBTWrapper1_11_R1(org.bukkit.inventory.ItemStack item) {
        super(item);
    }
    ...
    public void set(String key, SoundEventSelection value) {
        ...
        selection.setFloat("volume", value.getVolume());
        selection.setFloat("pitch", value.getPitch());
